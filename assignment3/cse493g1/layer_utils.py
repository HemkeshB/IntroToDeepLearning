...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param, normalization, use_dropout, dropout_param):
...
def affine_batchnorm_relu_backward(dout, cache, normalization, drop):
