...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # First affine layer
        self.params["W2"] = np.random.normal(0, weight_scale, (num_filters * H_out* W_out, hidden_dim)) 
    ...
    def loss(self, X, y=None):
        ...
        scores, cache_cnn = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(softmax_grad, cache_affine)
        dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, cache_affine_relu)
        dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout, cache_cnn)
